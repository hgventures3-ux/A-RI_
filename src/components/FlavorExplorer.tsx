...
const t = {
  fr: {
    ...
    subtitle: "Découvrez notre collection artisanale de Makhana — Graines Soufflées premium.",
    products: [
      {
        id: "salt",
      ...
      },
      {
        ...
        category: "B2B / VRAC",
        desc: "Makhana brut de qualité supérieure. Idéal pour les professionnels de la restauration, importateurs et industriels alimentaires.",
        price: "Sur devis",
        image: "/flavor_salt.png",
        badge: "B2B",
      },
    ...
    roastedBadge: "Torréfié — jamais frit",
    waitlist: {
      title: "Liste Premium",
      body: "Merci de votre confiance ! Vous faites désormais partie de notre liste de clients 'Premium'. Pour l'instant, nous préparons notre arrivée nationale dans votre épicerie habituelle. Nous vous remboursons votre commande aujourd'hui, mais vous serez le PREMIER à recevoir un coffret AÉRI offert dès que nous touchons le sol français. À bientôt dans votre rayon habituel !",
  ...
  en: {
    ...
    products: [
      ...
      },
      {
        ...
        name: "Raw Premium Bulk Kernels",
        category: "B2B / BULK",
        desc: "Premium raw makhana kernels. Ideal for food service professionals, importers, and food manufacturers.",
        price: "On request",
        image: "/flavor_salt.png",
        badge: "B2B",
      },
    ...
    roastedBadge: "Roasted — never fried",
    waitlist: {
      title: "Premium List",
      body: "Thank you for your trust! You are now part of our 'Premium' client list. We are currently preparing our national launch at your local grocer. We will reimburse your order today, but you will be the FIRST to receive a complimentary AÉRI gift box as soon as we arrive in France. See you soon!",
